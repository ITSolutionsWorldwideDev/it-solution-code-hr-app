...
export function mapApplicationStageToPipelineStage(stage: ApplicationStageApi): PipelineStage | null {
  switch (stage) {
    case "hr_invite_sent":
...
export function mapApplicationToPipelineCandidate(
  ...
  const stage = mapApplicationStageToPipelineStage(application.stage);
