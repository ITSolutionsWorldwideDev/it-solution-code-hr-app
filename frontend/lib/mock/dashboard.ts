...
const hrDashboard: DashboardData = {
    ...
    recentActivity: [
      ...
      {
        id: "activity-3",
        title: "Candidate sent to pipeline for technical review",
        status: "HR Approval",
        timestamp: "1 day ago",
...
const technicalDashboard: DashboardData = {
  ...
  kpis: [
    ...
    { label: "Average Technical Score", value: "8.6", delta: "Across active rounds", icon: ShieldCheck, tone: "sky" },
  ],
  recentActivity: [
    {
      id: "tech-1",
...
const managerDashboard: DashboardData = {
  ...
  kpis: [
    ...
    { label: "Selected This Month", value: "9", delta: "+3 vs last month", icon: ShieldCheck, tone: "sky" },
